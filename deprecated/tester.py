...
if __name__ == "__main__":
    ...
    print("Current file path:", os.path.dirname(os.path.abspath(__file__)))
    print("Current file path's file path:", os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
